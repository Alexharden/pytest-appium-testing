...
# login_text = 'new UiSelector().textMatches(".*登入.*")'
...
# target_text = 'new UiSelector().textMatches(".*Chro.*")' #.*代表任意字元
target_text = 'new UiSelector().textMatches("^Chro.*")'  # ^代表開頭
...
# play_text = 'new UiSelector().textMatches(".*Play.*")'
play_text = 'new UiSelector().textMatches("^Play.*")'
...
# yt_text = 'new UiSelector().textMatches(".*You.*")'
yt_text = 'new UiSelector().textMatches("^You.*")'
...
# phone_text = 'new UiSelector().textMatches(".*Phon.*")'
phone_text = 'new UiSelector().textMatches("^Phon.*")'
