...
try:
    ...
    wait.until(
        EC.presence_of_element_located((AppiumBy.XPATH, '//android.widget.TextView[@content-desc="Messages"]'))
    ).click()

    # 點擊主畫面的搜尋列 ID
    search_bar = wait.until(
        EC.presence_of_element_located((AppiumBy.ID, "com.google.android.apps.messaging:id/open_search_bar_text_view"))
    )
    search_bar.click()
